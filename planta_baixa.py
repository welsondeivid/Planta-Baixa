...
def planta(pygame):
    ...
    "sala": [
        ...
        moveis.movel("Mesa de centro", 1.00, 0.60, cor.BLACK, escala, ut.encontrar_comodo(ROOMS, "sala")),
    ...
    "salaDeJantar": [
        ...
        moveis.movel("Cristaleira", 0.34, 0.84, cor.BLACK, escala, ut.encontrar_comodo(ROOMS, "salaDeJantar"))
    ],
    "quarto": [
        ...
        moveis.movel("Guarda-roupa com duas portas", 0.40, 1.00, cor.BLACK, escala, ut.encontrar_comodo(ROOMS, "quarto")),
    ...
    "cozinha": [
        ...
        moveis.movel("Geladeira com 2 portas", 0.83, 0.79, cor.BLACK, escala, ut.encontrar_comodo(ROOMS, "cozinha")),
    ...
    "banheiro": [
        ...
        # moveis.movel("Box de banheiro", 1.50, 2.00, cor.BLACK, escala, ut.encontrar_comodo(ROOMS, "banheiro"))
    ],
    "areaServico": [
    ...
    "ginastica": [
        moveis.movel("Esteira", 1.50, 0.70, cor.BLACK, escala, ut.encontrar_comodo(ROOMS, "ginastica")),
